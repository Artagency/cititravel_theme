...
<div class="main-content main-content--subpage main-content--blog">
	<div class="container">
		<div class="row">
			...
			<?php 
				$image_small = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'blog-small');
				$image_medium = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'blog-medium');
				$image_tall = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'blog-tall');
			?>

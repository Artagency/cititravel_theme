...
foreach($data->grp as $dat) {
    ...
    //if(!empty($images)) {
?>
<div class="offer-item col-lg-4 col-md-6">
    <div class="offer-item-photo">
        <?php $page_path = get_page_by_path($arr->obj->{'@attributes'}->xCode,OBJECT,'hotels');
                                ...
                                <a href="<?=add_query_arg(array('oferta' => $arr->{'@attributes'}->id), get_permalink($page_path));?>">
                                    <img data-src="<?=(!empty($images))?$images[0]:get_template_directory_uri().'/img/cititravel-placeholder.jpg';?>" alt="" />
        </a>   
    ...
    <div class="offer-item-details">
        ...
        <div class="tripDetails">
            ...
            <div class="bottom">
                <span class="first">Wyżywienie:</span> <span><?php
                ...
                <span class="first">Organizator:</span> <span><?php

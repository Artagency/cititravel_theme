...
foreach($terms as $term) {
    ...
    if($code == trim($data->ofr->{'@attributes'}->tourOp)) {
        $tourOperator = $term;
        continue;
    }
}
...
$GLOBALS['hotel_name'] = 'Hotel '.$ofr->obj->{'@attributes'}->name;
?>
				...
				<div class="search-panel-small">
						...
						<form id="offer_preview" action="<?php echo admin_url('admin-ajax.php'); ?>">
							...
							<div class="row row--feature">
								...
								<div class="col-lg-8 col-md-12">
									<div class="input-hld">
										<select name="par_adt" id="par_adt">
							...
							<div class="row row--feature">
								...
								<div class="col-lg-8 col-md-12">
									<div class="input-hld">
										<select name="par_chd" id="par_chd">
							...
							<div class="row row--feature">
								...
								<div class="col-lg-8 col-md-12">
									<div class="input-hld input-hld--disabled">
										<input type="text" class="data-wyjazdu-powrotu-sec" value="<?=date('d.m.Y', strtotime($ofr->trp->{'@attributes'}->depDate));?> - <?=date('d.m.Y', strtotime($ofr->trp->{'@attributes'}->rDepDate));?>" disabled>
									</div>
							...
							<div class="row row--feature">
								...
								<div class="col-lg-8 col-md-12">
									<span class="search-panel-span-small"><strong><?=$tourOperator->name;?></strong></span>
								</div>
							</div>
							<div class="row row--feature">
								<div class="col-lg-4 col-md-12">
								...
								<div class="col-lg-8 col-md-12">
									<span class="search-panel-span-small"><strong><?=$ofr->obj->{'@attributes'}->xCode;?>-<?=$ofr->{'@attributes'}->tourOp;?>-<?=$ofr->trp->{'@attributes'}->depDate;?></strong></span>
								</div>
							</div>
						</form>
					</div>
					...
					<div class="search-panel-small-price">
						<div class="row">
							...
							<div class="col-lg-4 col-md-12">
								<span class="price"><?=$ofr->{'@attributes'}->price;?> <?=$ofr->{'@attributes'}->operCurr;?></span>
							</div>
						</div>
    ...
    <div class="container-hld">
        ...
        <div class="search-form">
	        <form id="similar-offers-form">
	        	<div class="row">
		            <div class="col-md-4">
		                <label><?=($ofr->{'@attributes'}->type=='F')?'Wylot od':'Wyjazd od';?>
		                	<div class="input-hld">
		                		<input type="text" name="data-wyjazdu" id="data_wyjazdu" class="data-wyjazdu-powrotu" value="<?=date('d.m.Y', strtotime($trp_depDateFrom));?> - <?=date('d.m.Y', strtotime($trp_depDateTo));?>" />
		                	</div>
		                </label>
		            </div>
                    <?php
